import {
    AuthorWrapper, AuthorWrapperForm, AuthorTitle, AuthorForm, AuthorInput, AuthorSelekt, AuthorTextarea, AuthorButton,
    AuthorWrapperImg,
    AuthorImginput
} from "./AuthorWrapper"
...
export const AddAuthor = () => {
    ...
    const hendleSubmit = (evt) => {
        ...
        fetch('http://192.168.37.86:5000/author', {
            method: 'POST',
            headers: {
        ...
        <AuthorWrapper>
            <AuthorWrapperImg>
                <label htmlFor="imgafter">
                    ...
                    <AuthorImginput type='file' id="imgafter" name="imgafter" ref={imgRef} />
                </label>
            ...
            <AuthorWrapperForm>
                ...
                <AuthorForm onSubmit={hendleSubmit}>
                    ...
                    <AuthorInput ref={BirthRrf} type='number' placeholder='date_of_birth' />
                    <AuthorInput ref={DeathRrf} type='number' placeholder='date_of_death' />
                    <AuthorInput ref={CountryRrf} type='text' placeholder='country' />
                    <AuthorSelekt onChange={(evt) => console.log(evt.target.value)} name="genre_id" ref={generRrf}>
                        <option hidden>Janer</option>
                        <option value={1} name="genre_id" id={1} >Temuriylar davri </option>
                    ...
                    <AuthorTextarea ref={TextAreaRrf} placeholder="Bio" name="bio" id="bio" />
